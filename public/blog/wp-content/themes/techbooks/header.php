...
<meta name="keywords" content="Books, Love stories, Comics, Art & culture">
<!-- Document Title -->
				...
				<div class="mega-dropdown-wrapper">
					...
					<div class="navigation">
						<ul>
							...
							<li><a href="/about"><i class="fa fa-files-o"></i>About</a></li>
							<li><a href="/blog"><i class="fa fa-blog"></i>Blog</a></li>
							<li><a href="/gallery"><i class="fa fa-files-o"></i>gallery</a></li>
							<li><a href="/author"><i class="fa fa-file-text"></i>author</a></li>
							<li><a href="/contact"><i class="fa fa-fax"></i>contact</a></li>
						</ul>
					</div>				
					<!-- Navigation -->
				</div>

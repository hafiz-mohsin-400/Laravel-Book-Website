...
<meta name="keywords" content="funny books, love stories, comics, art and cultures"/>
<!-- Document Title -->
				...
				<div class="mega-dropdown-wrapper">
					...
					<div class="navigation">
						<ul>
							...
							<li class=""><a href="/blog"><i class="fa fa-th-large"></i>Blog</a></li>
							<li class=""><a href="/gallery"><i class="fa fa-image"></i>Gallery</a></li>

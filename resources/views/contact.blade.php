		...
		<div class="tc-padding">
			<div class="container">
				...
				<div class="form-holder">
	        		...
	        		<!-- Sending Form -->
	        		<form class="sending-form" action="{{ route('contact') }}" method="post">
	        			{{ csrf_field() }}
	        			<div class="row">
	        				<div class="col-sm-12">
			        			<div class="form-group">
			        				<textarea class="form-control" name="message" required="required" rows="5" placeholder="Text here..."></textarea>

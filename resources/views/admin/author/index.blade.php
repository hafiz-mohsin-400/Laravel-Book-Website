	...
	<section class="content">
	    <div class="box">
	        <div class="box-header with-border">
	            <h3 class="box-title">
	                <a id="activeAllStatus" url="{{ route('author.active') }}" class="btn btn-danger btn-xm"><i class="fa fa-eye"></i></a>
	                <a id="deactiveAllStatus" url="{{ route('author.deactive') }}" class="btn btn-danger btn-xm"><i class="fa fa-eye-slash"></i></a>
	        ...
	        <div class="box-body">
	            ...
	            <table class="table table-bordered">
	                ...
	                <tr>
	                    <td><input type="checkbox" name="statusAll[]" id="{{ $author->id }}" class="checkSingle"></td>
	                    <td>{{ $author->title }}</td>
	                    ...
	                    <td>
	                        ...
	                        @else
	                            <img src="/uploads/{{ $author->author_img }}" class="img-thumbnail" width="100" alt="{{ $author->title }}">
	                        @endif
	                    </td>
	                    <td>
